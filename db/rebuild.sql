...
CREATE TABLE bookings ( id int(11) AUTO_INCREMENT NOT NULL PRIMARY KEY, clubid int(11) NOT NULL, trackid int(11) NOT NULL, startTime timestamp NOT NULL, endTime timestamp NOT NULL, bookedTime timestamp NOT NULL, comment text);
